# Generated by Django 3.0.4 on 2020-03-12 12:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='product',
            name='category',
            field=models.ManyToManyField(blank=True, related_name='category', to='products.Category', verbose_name='Категория'),
        ),
        migrations.AddField(
            model_name='product',
            name='manufacturer',
        ...
        migrations.AddField(
            model_name='product',
            name='order',
            field=models.ManyToManyField(related_name='order', through='products.Cart', to='orders.Order', verbose_name='Заказ'),
        ),
        migrations.AddField(
            model_name='product',
            name='sale',
